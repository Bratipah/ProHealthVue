<template>
  <div class="container">
    ...
    <div class="bg-indigo-600 hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
      <img src="../../assets/images/about.jpg" alt="" class="w-full h-full object-cover" />
    </div>
    ...
    >
      <div class="w-full h-100">
        ...
        <p class="mt-8">
          Need an account?
          <RouterLink to="/register" class="text-blue-500 hover:text-blue-700 font-semibold">Create an account</RouterLink>
        </p>
      </div>
    </div>
  </section>
...
export default {
    ...
    setup() {
        ...
        const Login = async () => {
            try{
                await store.dispatch('setGetLogin',{
                    email: email.value,
