<template>
  ...
  >
    ...
    >
      <div class="flex items-center flex-shrink-0 text-gray-800 mr-16">
        <a class="text-3xl font-bold leading-none" href="#">
          <svg class="h-10 mr-3" alt="logo" viewBox="0 0 10240 10240" fill="none">
            <path
          ...
          <span class="font-semibold text-xl tracking-tight">ProHealth</span>
        </a>
      </div>
    ...
    <div class="menu w-full lg:block flex-grow lg:flex lg:items-center lg:w-auto lg:px-3 px-8">
      ...
      <div class="flex">
        <div
          class="group flex h-15 w-15 cursor-pointer items-center justify-center rounded-3xl bg-white p-2 hover:bg-slate-200">
          <div class="space-y-2">
            <span
              class="block h-1 w-10 origin-center rounded-full bg-slate-500 transition-transform ease-in-out group-hover:translate-y-1.5 group-hover:rotate-45"
            ></span>
            <span
              class="block h-1 w-8 origin-center rounded-full bg-orange-500 transition-transform ease-in-out group-hover:w-10 group-hover:-translate-y-1.5 group-hover:-rotate-45"
            ></span>
          </div>
        </div>
